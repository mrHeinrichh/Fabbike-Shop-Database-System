...
Public Class TRANSACTIONcustomer
    ...
    Private Sub TRANSACTIONcustomer_Load(sender As Object, e As EventArgs) Handles MyBase.Load, Refresh.Click
        'connClass.OpenConnection()
        'sqlString = "SELECT * FROM fabbike_new.theCart INNER JOIN fabbike_new.Order_Transactionz ON theCart.Cart_ID = Order_Transactionz.Order_ID;"
    ...
    '    Private Sub accesrs()
    '        connClass.OpenConnection()
    '        sqlString = "SELECT DISTINCT customer.*, accessories.*, products.*, o.* FROM Order_Transactionz AS o
    'INNER JOIN Customerz AS customer ON o.customer_ID = customer.customer_ID
    'INNER JOIN Supplier_Products AS products ON o.Supplier_Product_ID = products.Supplier_Product_ID
    'INNER JOIN Supplier_Accessoriez AS  accessories ON o.Supplier_Accessories_ID = accessories.Supplier_Accessories_ID
    'INNER JOIN theCart AS tc ON tc.Cart_ID = o.Cart_ID"
    '        mydatarecords = connClass.selectFrom(sqlString)
    '        Dgrid3.DataSource = mydatarecords
    '    End Sub
    ...
    Private Sub BunifuButton18_Click(sender As Object, e As EventArgs) Handles BunifuButton18.Click
        'Suupplier has nothing to do with Customer Transaction
        orderTrans()
        customs()
        carts()
    End Sub
    ...
    Private Sub Dgrid3_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles Dgrid3.CellContentClick
