...
Public Class salaryRecordCrystal
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "salaryRecordCrystal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bikeshop.salaryRecordCrystal.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_textbox6() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedsalaryRecordCrystal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As salaryRecordCrystal = New salaryRecordCrystal()
        rpt.Site = Me.Site
        Return rpt
    End Function
